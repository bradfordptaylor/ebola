...
real_lambda = 1/20;  %mock value obtained from case data
...
%repeat method to obtain CI for R0
latticenum = 500;
...
savename = strcat('data/interpvec_simci_cum');
...
% figure is drawn
tmpfilename = 'figures/fig_simci_cum_large';
